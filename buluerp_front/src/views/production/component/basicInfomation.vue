<template>
    <el-form ref="mainFormRef" :model="mainFormState" label-width="120px" class="search-form">
      ...
      <el-card>
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-text line-clamp="2">产品编码<br />123456789000000<br /></el-text>
          </el-col>
          <el-col :span="8">
            <el-text line-clamp="2">创建日期<br />2025-04-01 23:11:11<br /></el-text>
          </el-col>
          <el-col :span="8">
      ...
      <el-card>
        ...
        <el-steps :active="1" align-center>
            <el-step title="填写产品组装物料信息"></el-step>
            <el-step title="填写产品包装信息"></el-step>
  ...
  const handleChange = (file: any) => {
    ...
    reader.onload = (e) => {
      fileList.value.push({ url: e.target?.result as string })
    }
  ...
  const submitMainForm = () => {
    mainFormRef.value?.validate((valid) => {
      if (valid) {
        console.log('主表单提交成功', mainFormState)
