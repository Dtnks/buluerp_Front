...
const newFormData = ref([
  ...
  [
    { type: 'input', label: '出模数', key: 'mouldOutput', width: 8 },
  ...
  [
    ...
    { type: 'input', label: '单重', key: 'singleWeight', width: 12 },
  ],
  [
    { type: 'timer', label: '排产时间', key: 'productionTime', width: 12, timerType: 'date' },
