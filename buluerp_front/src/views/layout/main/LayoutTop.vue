...
<template>
  <div id="menu" class="row">
    <div class="center">
      <img class="icon" src="@/assets/icon/u35.png" @click="props.handleHiddenMenu()" :class="reverse" />
    </div>
    ...
    <div style="width: 15vw" class="row pad">
      <div class="center" style="flex: 1">
        <div class="notification-icon-wrapper">
          <svg class="icon notification-icon" style="
              ...
              fill: currentColor;
              overflow: hidden;
            " viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="11867">
            <path
      ...
      <div class="center" style="flex: 1" @click="
        props.addTab(
          '我的信息',
